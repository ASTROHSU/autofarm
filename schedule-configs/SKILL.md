...
description: 每日早上 9 點掃描 X、Facebook、Gmail、YouTube 及固定資訊來源，產出區塊勢每日摘要（含視覺圖表與社群討論）。週五額外產出週報彙整。
---
...
掃描 X（Twitter）、Facebook、Gmail 電子報、YouTube 頻道、固定追蹤網站中過去 24 小時與「區塊鏈」或「科技」直接相關的重要事件，透過網路搜尋補充背景，產出：
